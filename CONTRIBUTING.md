...
When submitting an issue, please describe it as clearly as possible, including:
- How to reproduce the bug
- Which situations it appears in
- What you expected to happen
- What actually happens
- Whether this is a bug in Beaconleaf-specific features or in the base Overleaf functionality
...
- **Feature additions**: We're looking for features that enhance Overleaf but are unlikely to be merged upstream (e.g., global dark mode, administrator tools, symbol palette)
- **Bug fixes**: If you fix a bug in base Overleaf functionality, please contribute it to [upstream Overleaf](https://github.com/overleaf/overleaf) instead
- **Beaconleaf-specific bugs**: Fixes for bugs introduced by Beaconleaf features are welcome here

See the [Overleaf wiki](https://github.com/overleaf/overleaf/wiki) for information on managing the Overleaf development environment and developer guidelines.
...
- For vulnerabilities in Beaconleaf-specific features: Please open a security advisory in this repository
