...
import { updateAnnouncement } from '../../util/api'
...
export default function EditAnnouncementModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.data?.error || t('error_updating_announcement'))
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <OLModal show={show} onHide={onHide} size="lg">
      <OLModalHeader>
        <OLModalTitle>{t('edit_announcement')}</OLModalTitle>
      </OLModalHeader>
